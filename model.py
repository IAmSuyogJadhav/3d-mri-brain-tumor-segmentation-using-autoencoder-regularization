...
#     y_true_t = K.constant(y_true)
#     y_pred_t = K.constant(y_pred)
#     y_true_t = K.reshape(y_true_t, (K.int_shape(y_true_t)[0], -1))
#     y_pred_t = K.reshape(y_pred_t, (K.int_shape(y_pred_t)[0], -1))
