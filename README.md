...
> I will start working on this one as soon as my exams are over, i.e., after 24th April. Stay tuned.
...
# TODO
- Implement the custom loss function that the author used. (L = L<sub>dice</sub> + 0.1 ∗ L<sub>L2</sub> + 0.1 ∗ L<sub>KL</sub> )
